      ...
      <div className="flex gap-2 mt-5">
        {!pathname.includes("cart") && (
          <button
            ...
            className="bg-indigo-500  hover:bg-violet-600 active:bg-indigo-700 focus:outline-none focus:ring focus:ring-violet-500 rounded-full py-1 px-2 flex-1 text-white text-bold"
          >
            Add to cart
          </button>
        )}
